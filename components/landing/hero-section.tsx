      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[42px] leading-[50px] md:text-[72px] font-bold md:leading-[85px]">
            Welcome to <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-block">LearnSphere</span>, the Future of <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">eLearning</span>
          </h1>

          <p className="text-[#393939] text-[16px] md:text-[18px] font-medium leading-[28px] md:leading-[30px] max-w-xl">
            Empowering instructors and learners with AI-driven tools, real-time collaboration, and gamified progress tracking.
          </p>
        ...
        <div className="flex justify-center md:justify-end">
          <div className="relative w-full max-w-md aspect-square bg-[#FDB927] border-4 border-black rounded-3xl overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            <img
              src="/landing-images/studio-workspace.svg"
              alt="LearnSphere Workspace"
