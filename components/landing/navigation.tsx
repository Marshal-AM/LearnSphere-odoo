    ...
    <div className="container mx-auto px-4 pt-8 pb-4">
      <nav className="flex items-center justify-between bg-white border-4 border-black rounded-xl px-5 py-3 max-w-2xl mx-auto shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="hidden md:flex items-center gap-6 flex-1 justify-center">
          ...
          <Link href="/courses" className="text-[18px] font-bold leading-[20px] hover:opacity-70 transition-opacity">
            Courses
          </Link>
          ...
          <Link href="/cart" className="text-[18px] font-bold leading-[20px] hover:opacity-70 transition-opacity">
            Cart(0)
          </Link>
        </div>
