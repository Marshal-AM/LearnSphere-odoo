  ...
  const projects = [
    {
      ...
      description:
        "Learn the fundamentals of user interface and user experience design. Create stunning digital products that users love.",
      tag: "Design",
      logo: "/landing-images/studio-logo.svg",
      bgColor: "bg-[#6366F1]",
      illustration: "/landing-images/studio-workspace.svg",
    },
    {
      title: "Full-Stack Web Development Bootcamp",
      description:
        "Become a full-stack developer with this comprehensive course covering React, Node.js, and modern database technologies.",
      tag: "Development",
      logo: "/landing-images/venture-logo.svg",
      bgColor: "bg-[#2F81F7]",
      illustration: "/landing-images/venture-workspace.svg",
    },
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Explore our <br />
            <span className="bg-[#FFC224] text-black px-3 py-1 inline-block">featured courses</span>
          </h2>
        </div>
